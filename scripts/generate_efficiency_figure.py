...
DATA = {
    ...
    "Flax (Manual)": dict(
        sr  =[1.000, 0.960, 0.960, 0.960, 0.880, 0.667, 0.967, 0.900],
        time=[ 0.93,  2.00,  2.20,  1.91,  3.97,  4.53,  8.74, 11.90],
    ),
    # LLM model comparison (Stage 1 rules only, same GNN scorer)
    "Gemma3-12B": dict(
        sr  =[1.000, 1.000, 0.960, 0.980, 0.920, 0.700, 0.967, 1.000],
        time=[ 0.90,  0.95,  1.60,  2.15,  4.53,  5.98,  9.01, 10.98],
    ),
    "Qwen2.5-14B": dict(
